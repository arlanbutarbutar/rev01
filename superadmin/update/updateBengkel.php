...
$imageUploadPath = $path . $id_bengkel . ".jpg";
...
mysqli_query($konektor, "UPDATE bengkel SET nama_bengkel='$nama_bengkel', nama_pemilik='$nama_pemilik', no_hp='$no_hp', alamat='$alamat', jam_buka='$jam_buka', jam_tutup='$jam_tutup', deskripsi='$deskripsi' WHERE id_bengkel='$id_bengkel'");
