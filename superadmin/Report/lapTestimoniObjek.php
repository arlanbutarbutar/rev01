...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
	...
	<?php
	$no = 1;
	$idobjekwisata = $_POST['idobjekwisata'];//mengambil value dari url parameter	
  $data = mysqli_query($konektor,"SELECT tbl_testimoni.idtestimoni,tbl_testimoni.idwisatawan,tbl_testimoni.status,tbl_testimoni.idobjekwisata,tbl_testimoni.tanggal,tbl_wisatawan.namawisatawan,tbl_objekwisata.nama,tbl_testimoni.judul,tbl_testimoni.deskripsi,if(tbl_testimoni.status = '1','punlish','tunda') As publish FROM `tbl_testimoni`,tbl_wisatawan,tbl_objekwisata WHERE tbl_testimoni.idobjekwisata = $idobjekwisata and tbl_testimoni.idwisatawan = tbl_wisatawan.idwisatawan and tbl_testimoni.idobjekwisata = tbl_objekwisata.idobjekwisata");
